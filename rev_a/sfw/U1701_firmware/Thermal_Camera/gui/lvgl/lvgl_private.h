...
/* LOCAL MODIFICATION (Thermal_Camera): qrcode, barcode and gif were deleted
 * from this vendored tree -- see src/drivers/lv_drivers.h. */
...
/* LOCAL MODIFICATION (Thermal_Camera): the libinput and evdev platform
 * drivers were deleted from this vendored tree -- see
...
/* LOCAL MODIFICATION (Thermal_Camera): rlottie and ffmpeg were deleted from
 * this vendored tree -- see src/drivers/lv_drivers.h. */
