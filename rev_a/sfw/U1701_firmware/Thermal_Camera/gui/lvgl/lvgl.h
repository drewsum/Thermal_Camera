...
/* LOCAL MODIFICATION (Thermal_Camera): only the three libs kept in this
 * vendored tree are included here. barcode, bmp, rle, libpng, gif, qrcode,
 * tjpgd, libjpeg_turbo, freetype, rlottie, ffmpeg, tiny_ttf and svg were
 * deleted -- see src/drivers/lv_drivers.h for why this tree is trimmed
 * rather than merely configured off. */
