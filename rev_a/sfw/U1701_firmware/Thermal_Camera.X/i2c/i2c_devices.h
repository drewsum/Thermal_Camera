...
#define I2C_DEVICE_LIST(X) \
    ...
    X(I2C_DEV_PWR_1, I2C_DEVICE_KIND_INA231A, 0x40, "POS12 Input Gate") \
    X(I2C_DEV_PWR_2, I2C_DEVICE_KIND_INA231A, 0x41, "POS3P0 PSU") \
    X(I2C_DEV_PWR_3, I2C_DEVICE_KIND_INA231A, 0x42, "POS1P8 PSU") \
    X(I2C_DEV_PWR_4, I2C_DEVICE_KIND_INA231A, 0x43, "POS2P8 PSU") \
    X(I2C_DEV_PWR_5, I2C_DEVICE_KIND_INA231A, 0x44, "POS1P2 PSU") \
    X(I2C_DEV_PWR_6, I2C_DEVICE_KIND_INA231A, 0x45, "Backlight PSU")
