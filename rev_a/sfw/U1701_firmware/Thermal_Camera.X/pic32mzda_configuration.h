...
// DEVCFG3
// USERID = No Setting
#pragma config FMIIEN = OFF             // Ethernet RMII/MII Enable (RMII Disabled)
...
// ADEVCFG2
#pragma config_alt FPLLIDIV = DIV_2     // System PLL Input Divider (4x Divider)
#pragma config_alt FPLLRNG = RANGE_13_26_MHZ// System PLL Input Range (5-10 MHz Input)
#pragma config_alt FPLLICLK = PLL_POSC   // System PLL Input Clock Selection (FRC is input to the System PLL)
...
#pragma config_alt ICESEL = ICS_PGx1    // ICE/ICD Comm Channel Select (Communicate on PGEC2/PGED2)
...
#pragma config_auba PMDL1WAY = OFF       // Peripheral Module Disable Configuration (Allow multiple reconfigurations)
#pragma config_auba IOL1WAY = ON        // Peripheral Pin Select Configuration (Allow only one reconfiguration)

// AUBADEVCFG2
#pragma config_auba FPLLIDIV = DIV_3    // System PLL Input Divider (4x Divider)
#pragma config_auba FPLLRNG = RANGE_13_26_MHZ// System PLL Input Range (5-10 MHz Input)
#pragma config_auba FPLLICLK = PLL_POSC  // System PLL Input Clock Selection (FRC is input to the System PLL)
...
#pragma config_auba ICESEL = ICS_PGx1   // ICE/ICD Comm Channel Select (Communicate on PGEC2/PGED2)
...
#pragma config_uba PMDL1WAY = OFF        // Peripheral Module Disable Configuration (Allow multiple reconfigurations)
#pragma config_uba IOL1WAY = ON         // Peripheral Pin Select Configuration (Allow only one reconfiguration)

// UBADEVCFG2
#pragma config_uba FPLLIDIV = DIV_3     // System PLL Input Divider (4x Divider)
#pragma config_uba FPLLRNG = RANGE_13_26_MHZ// System PLL Input Range (5-10 MHz Input)
#pragma config_uba FPLLICLK = PLL_POSC   // System PLL Input Clock Selection (FRC is input to the System PLL)
...
#pragma config_uba ICESEL = ICS_PGx1    // ICE/ICD Comm Channel Select (Communicate on PGEC2/PGED2)
