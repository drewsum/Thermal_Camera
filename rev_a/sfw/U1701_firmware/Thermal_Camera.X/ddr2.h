...
// overwrites all DDR2 contents -- do not call once anything is using it (it
// runs automatically at boot, before anything is placed in DDR2). See the
// definition in ddr2.c for details.
